...
let op_info = [
  ...
  opPERFORM, (Nothing, "tbd");
  opRESUME, (Nothing, "tbd");
  opRESUMETERM, (Uint, "tbd");
  opREPERFORMTERM, (Uint, "tbd");
];;
...
let print_instr ic =
  ...
  begin try
    ...
    descr := snd info;
    begin
    if shape <> Nothing && shape <> Switch then pp_print_string ppf " ";
    match shape with
